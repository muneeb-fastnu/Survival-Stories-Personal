...
public class FirebaseSignIn : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        InvokeRepeating(nameof(SavePlayerPosFireBase), 30f, 1f);
    }
    void InitFirebase()
    {
    ...
    public void SignOut()
    {
        ...
        {
            Debug.Log("Firebase authentication is not initialized.");
        }
    }
    ...
    public async Task<object> ReadDatabaseAsync(string dataTitle)
    {
        ...
        if (user != null)
        {
            result = await firebaseData.ReadDirectDatabaseAsync(user.UserId, dataTitle);
        }
        else
        {
    ...
    public void SavePlayerPosFireBase()
    {
        Debug.Log("inside SaveDataOnFirebase");
        if (user != null)
        {
            string id = user.UserId;
            Debug.Log("user is not null and id is PlayerPos: " + user.UserId);
...
public void SaveDataOnFireBase()
    {
        ...
        if(user != null)
        {
            ...
            if(PlayerPrefs.HasKey("gold"))
            {
                ...
                Debug.Log("Attempting to write on database gold: " + goldAmount);
...
[System.Serializable]
public class SkillNames2
{
    public List<string> allNames;
    public List<int> allSkillTiers;
}