...
{
    // Gamepad input action map. Assets/ControlMaps/GamepadControls
    private GamepadControls rollingControls;
    public Button itemHolderTooltip;
    /// <summary>
    ...
    /*
        rollingControls.gameplay.holdUI.performed += context =>
        {
            if (context.interaction is HoldInteraction)
            {
                //function
                Debug.Log("Hold New UI");
            }
        };
    */
        rollingControls.gameplay.holdUI.performed += LongPressButton;
    ...
    public void LongPressButton(InputAction.CallbackContext context)
    {
